...
function AboutPage(){
    return(
        ...
        <div className='w-full h-[100dvh] bg-[] overflow-auto font-varela relative z-1'>
            <Navbar></Navbar>
            <PageTransition>
                <h1 className='h-[min(40dvh,280px)] text-[clamp(80px,10vw,100px)] text-white text-center bg-[#00bbfa] pt-[min(16dvh,112px)] shadow max-[701px]:text-[min(15vw,105px)] max-[701px]:h-[min(45vw,315px)] max-[701px]:pb-[20vw]' style={{textShadow: '0 0 4px #00749ab7, 0 0 4px #00749ab7, 0 0 4px #00749ab7'}}>About</h1>
                <WaveHeader></WaveHeader>


                <div className='flex flex-row w-full justify-center'>
                    <div className='flex flex-row w-full justify-center gap-[5%]'>
                        <img src={photo2} className='w-[20vw] h-[20vw] max-[701px]:w-[25vw] max-[701px]:h-[25vw]'></img>
